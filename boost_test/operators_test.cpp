...
// Note: operators don't actually modify the stream, just generate a modified
// output. So we compare the vale of the "stream" with unmodified input values
...
BOOST_AUTO_TEST_CASE(assignment_operators) {
  ...
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::shift_left_assign>()(i, j),
                    (iexp <<= jexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::shift_left_assign>()(j, i),
                    (jexp <<= iexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::shift_right_assign>()(i, j),
                    (iexp >>= jexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::shift_right_assign>()(j, i),
                    (jexp >>= iexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::multiplies_assign>()(i, j),
                    (iexp *= jexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::multiplies_assign>()(j, i),
                    (jexp *= iexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::divides_assign>()(i, j),
                    (iexp /= jexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::divides_assign>()(j, i),
                    (jexp /= iexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::modulus_assign>()(i, j),
                    (iexp %= jexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::modulus_assign>()(j, i),
                    (jexp %= iexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  ...
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::bitwise_and_assign>()(i, j),
                    (iexp &= jexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::bitwise_and_assign>()(j, i),
                    (jexp &= iexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::bitwise_or_assign>()(i, j),
                    (iexp |= jexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::bitwise_or_assign>()(j, i),
                    (jexp |= iexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::bitwise_xor_assign>()(i, j),
                    (iexp ^= jexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
  BOOST_CHECK_EQUAL(functor_of<bp::tag::bitwise_xor_assign>()(j, i),
                    (jexp ^= iexp));
  BOOST_CHECK(i == i0 && j == j0);
  iexp = i0;
  jexp = j0;
...
BOOST_AUTO_TEST_CASE(if_else_) {
  BOOST_CHECK_EQUAL(functor_of<bp::tag::if_else_>()(true, i, j),
                    (true ? iexp : jexp));
  BOOST_CHECK(i == i0 && j == j0);
  BOOST_CHECK_EQUAL(functor_of<bp::tag::if_else_>()(true, j, i),
                    (true ? jexp : iexp));
  BOOST_CHECK(i == i0 && j == j0);
  BOOST_CHECK_EQUAL(functor_of<bp::tag::if_else_>()(false, i, j),
                    (false ? iexp : jexp));
  BOOST_CHECK(i == i0 && j == j0);
  BOOST_CHECK_EQUAL(functor_of<bp::tag::if_else_>()(false, j, i),
                    (false ? jexp : iexp));
  BOOST_CHECK(i == i0 && j == j0);
}
