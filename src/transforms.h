...
template <typename Type> struct BaseType<std::shared_ptr<Type>> {
  static const bool value = true;
  using type = Type;
};

template <typename Sig> struct MakeStropPtrType {
...
struct AddStropToGraph : proto::callable {
  ...
  const StropType operator()(State engine, StropType strop) {
    ...
    if (engine->IsVerbose()) {
      std::cout << "AddStropToGraph: " << strop << " returning "
                << strop->GetDescriptor() << std::endl;
    }
    return strop;
  }
};
...
struct generic_func : proto::callable {
  ...
  typename result<generic_func(State, const F &)>::type operator()(State engine,
                                                                   const F &f) {
    if (engine->IsVerbose()) {
    ...
    std::shared_ptr<FuncStropType> funcStropPtr =
        std::make_shared<FuncStropType>(f);
  ...
  // Arity = 1
  template <typename State, typename FArg, typename Arg1Strop>
  ...
  template <typename State, typename F, typename Arg1Strop>
  typename result<generic_func(State, const F &, Arg1Strop)>::type
  operator()(State engine, const F &f, const Arg1Strop arg1) {
    if (engine->IsVerbose()) {
      std::cout << "generic_func" << std::endl;
    }
    ...
    typename BaseType<Arg1Strop>::type::OutputStreamPtr arg1Stream(
        arg1->MakeOutputStream());
  ...
  operator()(State engine, const F &f, const Arg1Strop arg1,
    ...
    using FuncStropType =
        Func<F, strop_return_type<Arg1Strop>, strop_return_type<Arg2Strop>>;
    std::shared_ptr<FuncStropType> funcStropPtr =
        std::make_shared<FuncStropType>(f);

    typename BaseType<Arg1Strop>::type::OutputStreamPtr arg1Stream(
        arg1->MakeOutputStream());
    typename BaseType<Arg2Strop>::type::OutputStreamPtr arg2Stream(
        arg2->MakeOutputStream());
  ...
  // Arity = 3
  template <typename State, typename FArg, typename Arg1Strop,
            typename Arg2Strop, typename Arg3Strop>
  ...
  template <typename State, typename F, typename Arg1Strop, typename Arg2Strop,
            typename Arg3Strop>
  typename result<generic_func(State, const F &, Arg1Strop, Arg2Strop,
                               Arg3Strop)>::type
  operator()(State engine, const F &f, const Arg1Strop arg1,
             const Arg2Strop arg2, const Arg3Strop arg3) {
    if (engine->IsVerbose()) {
      std::cout << "generic_func" << std::endl;
    }
    ...
    typename BaseType<Arg2Strop>::type::OutputStreamPtr arg2Stream(
        arg2->MakeOutputStream());
    typename BaseType<Arg3Strop>::type::OutputStreamPtr arg3Stream(
        arg3->MakeOutputStream());
  ...
  // Arity = 4
  template <typename State, typename FArg, typename Arg1Strop,
            typename Arg2Strop, typename Arg3Strop, typename Arg4Strop>
  struct result<generic_func(State, FArg, Arg1Strop, Arg2Strop, Arg3Strop,
                             Arg4Strop)> {
    using F = remove_const_t<remove_reference_t<FArg>>;
    using Arg1Type = strop_return_type<Arg1Strop>;
  ...
  template <typename State, typename F, typename Arg1Strop, typename Arg2Strop,
            typename Arg3Strop, typename Arg4Strop>
  typename result<generic_func(State, const F &, Arg1Strop, Arg2Strop,
                               Arg3Strop, Arg4Strop)>::type
  operator()(State engine, const F &f, const Arg1Strop arg1,
             const Arg2Strop arg2, const Arg3Strop arg3, const Arg4Strop arg4) {
    if (engine->IsVerbose()) {
      std::cout << "generic_func" << std::endl;
    }
    ...
    using FuncStropType =
        Func<F, strop_return_type<Arg1Strop>, strop_return_type<Arg2Strop>,
             strop_return_type<Arg3Strop>, strop_return_type<Arg4Strop>>;
    ...
    typename BaseType<Arg3Strop>::type::OutputStreamPtr arg3Stream(
        arg3->MakeOutputStream());
    typename BaseType<Arg4Strop>::type::OutputStreamPtr arg4Stream(
        arg4->MakeOutputStream());
  ...
  template <typename State, typename F, typename Arg1Strop, typename Arg2Strop,
            typename Arg3Strop, typename Arg4Strop, typename Arg5Strop>
  typename result<generic_func(State, F &, Arg1Strop, Arg2Strop, Arg3Strop,
                               Arg4Strop, Arg5Strop)>::type
  operator()(State engine, const F &f, const Arg1Strop arg1,
             const Arg2Strop arg2, const Arg3Strop arg3, const Arg4Strop arg4,
    ...
    typename BaseType<Arg4Strop>::type::OutputStreamPtr arg4Stream(
        arg4->MakeOutputStream());
    typename BaseType<Arg5Strop>::type::OutputStreamPtr arg5Stream(
        arg5->MakeOutputStream());
    funcStropPtr->SetInputs(arg1Stream, arg2Stream, arg3Stream, arg4Stream,
                            arg5Stream);
...
struct HandleTerminal : proto::callable {
  ...
  typename boost::enable_if<
      BaseType<StropType>,
      typename result<HandleTerminal(State, StropType)>::type>::type
  ...
  typename boost::disable_if<
      BaseType<ConstType>,
      typename result<HandleTerminal(State, ConstType)>::type>::type
...
struct SlidingWindow : proto::callable {
  ...
  operator()(State engine, const int &size, const ArgStrop arg) {
    ...
    std::shared_ptr<WindowStropType> strop =
        std::make_shared<WindowStropType>(size);

    typename BaseType<ArgStrop>::type::OutputStreamPtr argStream(
